...
const Modal = ({
  ...
  return (
    <div
      className="absolute top-0 left-0 h-full w-full flex justify-center items-center bg-gray-800/40 px-3"
    ...
    >
      ...
      >
        ...
        <section
          className={`grow overflow-y-auto w-full flex justify-center ${bodyClasses}`}
        >
          {children}
        </section>
